...
pub mod allocation_elision_gate;
...
pub mod budget_propagation_contract;
pub mod budgeted_optimization;
pub mod budgeted_synthesis_engine;
pub mod bulkhead;
pub mod bytecode_vm;
pub mod cache_oblivious_metadata_substrate;
pub mod calibration_sentinel;
pub mod callback_stdlib_dispatch;
pub mod cancel_mask;
...
pub mod causal_intervention_planner;
...
pub mod contextual_policy_selector;
pub mod control_plane;
pub mod control_plane_benchmark_split_gate;
pub mod control_plane_mock_inventory;
pub mod control_plane_policy_diagnostics;
...
pub mod descent_certificate_gate;
pub mod deterministic_probabilistic_telemetry;
...
pub mod entropic_policy_morphing;
...
pub mod esm_cjs_parity_evidence;
pub mod esm_loader;
...
pub mod frankenlab_bridge_contract;
pub mod frankenlab_extension_lifecycle;
pub mod frankenlab_gap_matrix;
pub mod frankenlab_harness_migration;
pub mod frankenlab_release_gate;
pub mod frankenlab_release_gate_promotion;
pub mod frankenlab_surface_gap_matrix;
pub mod frankentui_adapter;
pub mod frir_schema;
pub mod frontier_complex_cartography;
...
pub mod hardware_localization_residual;
pub mod hardware_parameter_manifold;
pub mod hash_tiers;
pub mod hierarchical_delta_debug;
pub mod hindsight_boundary_capture;
pub mod hindsight_escalation_bundle;
pub mod hindsight_trace_escalator;
...
pub mod hostcall_session_protocol;
pub mod hostcall_telemetry;
pub mod hot_path_telemetry_kernel;
...
pub mod metadata_substrate_optimized;
...
pub mod module_index_parity_gate;
...
pub mod parser_event_ast_equivalence;
...
pub mod regime_shift_detector;
pub mod regime_signature_feature;
...
pub mod semantic_dark_matter_engine;
pub mod semantic_flattening_inventory;
...
pub mod specialization_rollback_gate;
pub mod spectral_fleet_convergence;
pub mod stage_envelope_certificate;
...
pub mod vectorized_lane_contract;
pub mod vectorized_lane_governance_gate;
