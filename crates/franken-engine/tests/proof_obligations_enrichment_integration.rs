...
fn obligation_id_serde_roundtrip() {
    ...
    let restored: ObligationId = serde_json::from_str(&json).unwrap();
...
fn category_serde_all_roundtrip() {
    for cat in &ObligationCategory::ALL {
        ...
        let restored: ObligationCategory = serde_json::from_str(&json).unwrap();
...
fn severity_serde_all_roundtrip() {
    for sev in [
        ...
        let restored: ObligationSeverity = serde_json::from_str(&json).unwrap();
...
fn evidence_requirement_all_variants_serde() {
    ...
    for ev in &variants {
        ...
        let restored: EvidenceRequirement = serde_json::from_str(&json).unwrap();
...
fn obligation_template_serde_roundtrip() {
    ...
    let restored: ObligationTemplate = serde_json::from_str(&json).unwrap();
...
fn obligation_binding_serde_roundtrip() {
    ...
    let restored: ObligationBinding = serde_json::from_str(&json).unwrap();
...
fn obligation_evaluation_serde_roundtrip() {
    ...
    let restored: ObligationEvaluation = serde_json::from_str(&json).unwrap();
...
fn obligation_report_serde_roundtrip() {
    ...
    let restored: ObligationReport = serde_json::from_str(&json).unwrap();
