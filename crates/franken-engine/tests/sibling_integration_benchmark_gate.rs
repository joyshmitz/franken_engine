...
fn decision_serde_roundtrip() {
    ...
    let restored: BenchmarkGateDecision = serde_json::from_str(&json).unwrap();
...
fn input_serde_roundtrip() {
    ...
    let restored: BenchmarkGateInput = serde_json::from_str(&json).unwrap();
...
fn thresholds_serde_roundtrip() {
    ...
    let restored: BenchmarkGateThresholds = serde_json::from_str(&json).unwrap();
...
fn ledger_serde_roundtrip() {
    ...
    let restored: BaselineLedger = serde_json::from_str(&json).unwrap();
...
fn ledger_error_serde_roundtrip() {
    ...
    for err in &errs {
        ...
        let restored: BaselineLedgerError = serde_json::from_str(&json).unwrap();
