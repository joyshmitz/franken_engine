...
fn governance_decision_type_serde_round_trip() {
    for dtype in [
        ...
        let recovered: GovernanceDecisionType = serde_json::from_str(&json).unwrap();
...
fn governance_actor_serde_roundtrip() {
    for actor in [
        ...
        let recovered: GovernanceActor = serde_json::from_str(&json).unwrap();
...
fn scorecard_snapshot_serde_roundtrip() {
    ...
    let recovered: ScorecardSnapshot = serde_json::from_str(&json).unwrap();
...
fn governance_rationale_serde_roundtrip() {
    ...
    let recovered: GovernanceRationale = serde_json::from_str(&json).unwrap();
...
fn governance_ledger_config_serde_roundtrip() {
    ...
    let recovered: GovernanceLedgerConfig = serde_json::from_str(&json).unwrap();
...
fn governance_ledger_query_serde_roundtrip() {
    ...
    let recovered: GovernanceLedgerQuery = serde_json::from_str(&json).unwrap();
    ...
    let all_recovered: GovernanceLedgerQuery = serde_json::from_str(&all_json).unwrap();
...
fn governance_ledger_error_serde_roundtrip() {
    ...
    for err in &errors {
        ...
        let recovered: GovernanceLedgerError = serde_json::from_str(&json).unwrap();
...
fn governance_audit_ledger_serde_roundtrip() {
    ...
    let recovered: GovernanceAuditLedger = serde_json::from_str(&json).unwrap();
