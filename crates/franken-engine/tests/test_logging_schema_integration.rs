...
fn serialize_redaction_audit_report_is_deterministic() {
    ...
    let serialized_a = serialize_redaction_audit_report(&report_a).unwrap();
    let serialized_b = serialize_redaction_audit_report(&report_b).unwrap();
...
fn serialize_redaction_audit_report_roundtrip_is_lossless() {
    ...
    let decoded = deserialize_redaction_audit_report(&serialized).unwrap();
