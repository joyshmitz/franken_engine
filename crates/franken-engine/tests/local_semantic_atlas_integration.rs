...
fn local_semantic_atlas_serde_roundtrip() {
    ...
    let recovered: LocalSemanticAtlas = serde_json::from_str(&json).unwrap();
...
fn semantic_contract_version_serde_roundtrip() {
    ...
    let recovered: SemanticContractVersion = serde_json::from_str(&json).unwrap();
...
fn atlas_input_serde_roundtrip() {
    ...
    let recovered: LocalSemanticAtlasInput = serde_json::from_str(&json).unwrap();
