...
fn ts_normalization_config_default_is_constructible() {
    ...
    let recovered: TsNormalizationConfig = serde_json::from_str(&json).unwrap();
...
fn source_map_entry_serde_roundtrip() {
    ...
    let recovered: SourceMapEntry = serde_json::from_str(&json).unwrap();
...
fn capability_intent_serde_roundtrip() {
    ...
    let recovered: CapabilityIntent = serde_json::from_str(&json).unwrap();
...
fn normalization_decision_serde_roundtrip() {
    ...
    let recovered: NormalizationDecision = serde_json::from_str(&json).unwrap();
...
fn normalization_event_serde_roundtrip() {
    ...
    let recovered: NormalizationEvent = serde_json::from_str(&json).unwrap();
...
fn ts_normalization_witness_serde_roundtrip() {
    ...
    let recovered: TsNormalizationWitness = serde_json::from_str(&json).unwrap();
...
fn ts_normalization_output_serde_roundtrip() {
    ...
    let recovered: TsNormalizationOutput = serde_json::from_str(&json).unwrap();
...
fn ts_ingestion_event_serde_roundtrip() {
    ...
    let json = serde_json::to_string(&event).unwrap();
    let recovered: TsIngestionEvent = serde_json::from_str(&json).unwrap();
...
fn ts_ingestion_error_code_serde_roundtrip() {
    ...
    let recovered: TsIngestionErrorCode = serde_json::from_str(&json).unwrap();
...
fn source_language_serde_roundtrip() {
    for lang in [SourceLanguage::JavaScript, SourceLanguage::TypeScript] {
        ...
        let recovered: SourceLanguage = serde_json::from_str(&json).unwrap();
...
fn ts_compiler_options_serde_roundtrip() {
    ...
    let recovered: TsCompilerOptions = serde_json::from_str(&json).unwrap();
...
fn source_ingestion_summary_serde_roundtrip() {
    ...
    let recovered: SourceIngestionSummary = serde_json::from_str(&json).unwrap();
...
fn ts_ingestion_error_serde_roundtrip() {
    ...
    let recovered: TsIngestionError = serde_json::from_str(&json).unwrap();
