...
- trace_id: trace-parser-oracle-20260224T075617Z
- decision_id: decision-parser-oracle-20260224T075617Z
...
```bash
cargo run -p frankenengine-engine --bin franken_parser_oracle_report --   --partition smoke   --gate-mode report_only   --seed 1   --trace-id trace-parser-oracle-20260224T075617Z   --decision-id decision-parser-oracle-20260224T075617Z   --policy-id policy-parser-oracle-v1   --fixture-catalog crates/franken-engine/tests/fixtures/parser_phase0_semantic_fixtures.json
```
